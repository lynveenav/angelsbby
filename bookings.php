...
<body class="relative min-h-screen bg-gray-50">
  <img src="background.jpg" alt="Beautiful tropical beach" class="fixed inset-0 w-full h-full object-cover brightness-75 -z-10" />
  ...
  <div class="max-w-4xl mx-auto px-6 py-12">
    <div class="bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 md:p-16 max-w-xl mx-auto">
      ...
      <div class="mt-6 text-center">
        <a href="index.php" class="inline-block bg-teal-600 text-white py-2 px-6 rounded-lg hover:bg-teal-800">Go Back Home</a>
      </div>
